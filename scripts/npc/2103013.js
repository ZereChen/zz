...
function action(mode, type, selection) {
    ...
    if (status == 1) {
        if (cm.getMapId() >= 926020001 && cm.getMapId() <= 926020004) {
            ...
            cm.sendSimple("   你好 #b#h ##k ，你要去金字塔吗？很危险的，你能力够不够啊？\r\n#b#L1#进入金字塔副本#l\r\n#L2#进入法老副本#l\r\n#L3#兑换腰带#l\r\n#L4#兑换勋章#l#k");
        }
    } else if (status == 2) {
        section = selection;
        if (selection == 1) {
            ...
            if (mons < 杀怪数量) {
                cm.说明文字("请击杀 #b" + 杀怪数量 + "#k 只金字塔副本内的怪物，目前 : #b" + mons + "#k ");
            ...
            if (selection == 0) {
                ...
                if (cm.canHold(1132013)) {
                    if (cm.haveItem(2022613, 400) && cm.haveItem(1132012)) {
                        ...
                        cm.说明文字("我需要 #v2022613# #b#t2022613##k 400个 和一条 #b#v1132012##t1132012#。");
                    }
                    cm.说明文字("请空出一些空间。");
                }
            }
