...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "	Hi~#b#h ##k嘤嘤嘤嘤嘤嘤，你有 "+cm.显示物品(4031311)+" 吗？如果你提供给我，我可以造成大大大大的雪人哦。\r\n\r\n";
		 selStr += "       推雪人进度: #B"+雪花进度条+"# ["+雪花进度+"/3000]\r\n\r\n";
		
        selStr += " #L1##b领取手套#k#l  #L2##b领取雪球#k#l  #L3##b提交雪花#k#l  #L4##b雪花达人#k#l";
        cm.说明文字(selStr);
    } else if (status == 1) {
        switch (selection) {
            case 1:
