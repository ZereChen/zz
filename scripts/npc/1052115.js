...
function action(mode, type, selection) {
    ...
    if (执行 == 1) {
        if (cm.getMapId() == 910320001) {
            ...
            cm.sendSimple("   你好 #b#h ##k ，地铁站里遇到一些麻烦，你愿意帮助我吗？如果你愿意帮助我，我可以给予你 #v1142141#  #b#t1142141##k\r\n\r\n#b#L1#进入挑战\r\n#L2#进入列车\r\n#L3#领取勋章#l#k");
        }
    } else if (执行 == 2) {
        section = selection;
        if (selection == 1) {
            if (cm.getPlayer().getLevel() < 最低等级 || cm.getPlayer().getLevel() > 最高等级 || !cm.isLeader()) {
                cm.说明文字("你需要等级 #b"+最低等级+" - "+最高等级+"#k 之内，开启组队后找我。");
            } else {
