...
var qItems = new Array(
        ...
        "第二题: 下列怪物中，哪组怪物与打倒它所能得到的战利品是不正确对应关系的？#缎带肥肥- 蝴蝶结#煤泥 - 煤泥泡沫#绿色蜗牛 - 绿色蜗牛壳#食人花 - 食人花的叶子#4",
...
function action(mode, type, selection) {
    if (mode == -1)
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 1)
            cm.sendNextPrev("#h #, 如果你给我 #b黑暗水晶#k 我将会让你试着回答5个问题,若您5个问题都答对您将得到 #v4031058# #b#t4031058##k.");
        else if (status == 2) {
            ...
            if (selection == correctAnswer) {
                ...
                cm.sendOk("太可惜了，很抱歉你必须在给我一个 #b黑暗水晶#k 才可以再挑战!");
                cm.dispose();
            }
        }
    }
